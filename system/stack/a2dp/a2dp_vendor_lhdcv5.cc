...
static const tA2DP_LHDCV5_CIE a2dp_lhdcv5_source_caps = {
    ...
    // Frame Length select
    (A2DP_LHDCV5_FRAME_LEN_SELECT_2P5MS | A2DP_LHDCV5_FRAME_LEN_SELECT_5MS | A2DP_LHDCV5_FRAME_LEN_SELECT_10MS),
    // Max Target Bit Rate Type
    A2DP_LHDCV5_MAX_BIT_RATE_ALL,
    // Min Target Bit Rate Type
    A2DP_LHDCV5_MIN_BIT_RATE_ALL,
    // Extended MaxBitrate mode
    A2DP_LHDCV5_EXMBR_ALL,
...
static tA2DP_STATUS A2DP_ParseInfoLhdcV5(tA2DP_LHDCV5_CIE* p_ie,
  ...
  // SNK side: save decoder needed parameters from SRC's configuration
...
tA2DP_STATUS A2dpCodecConfigLhdcV5Base::setCodecConfig(const uint8_t* p_peer_codec_info,
  ...
  if (frameLenSelect == A2DP_LHDCV5_FRAME_LEN_SELECT_NS) {
    // undefined frameLenSelect
    log::error( ": fatal! invalid frameLenSelect:0x{:02X}", frameLenSelect);
    goto fail;
  }
